...
function Significado() {
    ...
    return (
        <>
            <article className={styles.art} id="definicao">
                <h1 className={styles.h2Main}>Definição: </h1>
                <p className={styles.par}>O <b>Índice de Massa Corporal &#40;IMC&#41;</b> é uma medida internacional usada para calcular se uma pessoa está no peso ideal. Ele é calculado dividindo-se o peso da pessoa em quilogramas pelo quadrado da altura em metros.</p>
